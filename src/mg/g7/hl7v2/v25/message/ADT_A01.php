...
namespace mg\g7\hl7v2\v25\message {
	...
	class ADT_A01 extends GenericMessage {
		public function __construct() {
			$this->structure = array (
					...
					"NK1" => array (
							"NK1" => SEGMENT_NOT_REQUIRED 
					),
					"PV1" => SEGMENT_REQUIRED,
					"DB1" => array (
							"DB1" => SEGMENT_NOT_REQUIRED 
					),
					"OBX" => array (
		...
		public function validateNK1($obj) {
			$option = array (
					SSMIX2_FIELD_OPTION_R,
					SSMIX2_FIELD_OPTION_R,
					SSMIX2_FIELD_OPTION_O,
		...
		public function validateDB1($obj) {
			$option = array (
					SSMIX2_FIELD_OPTION_R,
					SSMIX2_FIELD_OPTION_R,
					SSMIX2_FIELD_OPTION_R,
		...
		public function validateIN1($obj) {
			$option = array (
					SSMIX2_FIELD_OPTION_R,
					SSMIX2_FIELD_OPTION_R,
					SSMIX2_FIELD_OPTION_R,
		...
		public function getPDA() {
			return $this->getType ( $this->segments, "PDA", false, false );
		}
	}
}