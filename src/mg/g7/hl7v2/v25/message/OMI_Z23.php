...
namespace mg\g7\hl7v2\v25\message {
	...
	class OMI_Z23 extends GenericMessage {
		protected $structure;
		protected $segments;
		/**
		 */
		public function __construct() {
			$this->structure = array (
					...
					"ORDER" => array (
							...
							"ZE1" => array (
									"ZE1" => SEGMENT_NOT_REQUIRED 
							),
							"ZE2" => array (
									"ZE2" => SEGMENT_NOT_REQUIRED 
							),
							"IPC" => array (
									"IPC" => SEGMENT_REQUIRED 
							) 
					) 
			);
		...
		public function validateIPC($obj) {
			$option = array (
					SSMIX2_FIELD_OPTION_R,
					SSMIX2_FIELD_OPTION_R,
					SSMIX2_FIELD_OPTION_O,
		...
		public function validateZE1($obj) {
			$option = array (
					SSMIX2_FIELD_OPTION_R,
					SSMIX2_FIELD_OPTION_O,
					SSMIX2_FIELD_OPTION_R,
		...
		public function validateZE2($obj) {
			$option = array (
					SSMIX2_FIELD_OPTION_R,
					SSMIX2_FIELD_OPTION_O,
					SSMIX2_FIELD_OPTION_O,
